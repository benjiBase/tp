...
public class HelpWindow extends UiPart<Stage> {
    ...
    public static String getPatientCommands() {
        return """
                ...
                3. emergency (set emergency contact)
    ...
    public static String getTaskCommands() {
        return """
                ...
                Here are the list of Task Commands available:
                1. addtask (add task to a person)
                2. deletetask (delete task from a person)
                3. listtask (list all tasks)
                4. findtask (find a task)
